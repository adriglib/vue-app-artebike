  ...
  export default {
    ...
    methods: {
                    ...
                    .then(({data:reservaties}) => {
                     ...
                     // console.log('reservations API',this.rawReservatiesArray)
                      ...
                      //
                        ...
                        this.$set( this.reservatie, 'field_fietstype', fietstypeObject.name[0].value)
                        this.$set( this.reservatie, 'field_laadstation', laadstationObject.name)
                        this.$set( this.reservatie, 'field_uur', uurEnMinuut)
                        this.$set( this.reservatie, 'field_date', datumInfo[1])
                        this.$set( this.reservatie, 'field_latitude', laadstationObject.field_latitude)
                        this.$set( this.reservatie, 'field_longitude', laadstationObject.field_longitude)
      ...
      makeReservation () {
        ...
        axios.patch(`http://cms.localhost/artebike/reservatie/` + self.id,
          {
            "field_fietstype": [
              {
